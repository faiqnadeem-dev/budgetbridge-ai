...
const AnomalyMetrics = ({ anomalies }) => {
    ...
    return (
      <Paper sx={{ p: 3, borderRadius: 2, height: "100%" }}>
        ...
        <Typography variant="body2" color="text.secondary">
          No anomaly data available yet. As you record more transactions, our AI
          will detect unusual spending patterns and alert you to potential
          issues.
        </Typography>
      </Paper>
    );
  ...
  const totalAnomalyAmount = anomalies.reduce(
    (sum, anomaly) => sum + parseFloat(anomaly.amount),
    0
  );
  ...
  return (
    <Paper
      ...
      aria-labelledby="anomaly-insights-title"
    >
      <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
        <TrendingUp sx={{ mr: 1, color: "primary.main" }} />
        <Typography variant="h6" id="anomaly-insights-title">
          Anomaly Insights
        </Typography>
      </Box>
      ...
      <Box sx={{ mb: 3 }}>
        ...
        <Box sx={{ display: "flex", alignItems: "baseline" }}>
          <Typography variant="h4" color="error.main" sx={{ fontWeight: 600 }}>
            {formatAmount(totalAnomalyAmount)}
          </Typography>
      ...
      {topCategories.length > 0 && (
        <Box sx={{ mb: 3 }}>
          <Box sx={{ display: "flex", alignItems: "center", mb: 1 }}>
            ...
            <Typography variant="subtitle2" id="top-anomaly-categories">
              Top Anomaly Categories
            </Typography>
          </Box>
          <List dense disablePadding aria-labelledby="top-anomaly-categories">
      ...
      {topMonths.length > 0 && (
        <Box>
          <Box sx={{ display: "flex", alignItems: "center", mb: 1 }}>
            ...
            />
            <Typography variant="subtitle2" id="anomaly-time-patterns">
              Time Patterns
            </Typography>
          </Box>
          <List dense disablePadding aria-labelledby="anomaly-time-patterns">
